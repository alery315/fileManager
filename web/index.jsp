...
<%--
    ...
    <Context path="/video" docBase="/home" debug="0" reloadable="true"></Context>
--%>

<%
    String defaultDir = "/home/alery";
    String para;
    para = request.getParameter("dir") == null ? defaultDir : request.getParameter("dir");
